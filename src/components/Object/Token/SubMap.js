        ...
        <div className="w-full flex flex-col mt-2">
          ...
          {_FILTER.Offers[0].offer.length > 0 && (
            <div className="w-full bg-white bg-opacity-10 border-indigo-500 border-2 mb-2 rounded-xl">
              <div className="overflow-auto no-scroll-bar h-[20vh] lXs:h-[30vh] w-full flex flex-col items-center">
                <div className="w-full flex flex-col rounded-full px-[1vw] items-center">
                  {_FILTER.Offers[0] &&
                    _FILTER.Offers[0].offer.map((e, i) => {
                      return (
                        <div key={i + "_lastOffers"} className="w-full">
                          <div className="w-full flex flex-row rounded-full py-[2vw] px-[1vw] items-center">
                            <span className="text-indigo-500 text-[2.5vw] lXs:text-[1.5vw]">
                              FROM:
                            </span>
